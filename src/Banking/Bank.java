...
public class Bank {
	...
	/**
	 * Runs the program by intializing and managing, bank accounts and customers>
	 */
	public void run() {
		...
		System.out.print("Amount (decimal) to deposit into your checking account?");
		double amount = scanner.nextDouble();//get next token (double)
		checkingAccount.deposit(amount);//deposit into checking account
		
		//into savings
		System.out.println();//blank line
		System.out.print("Amount (decimal) to deposit into your savings account?");
		double amount1 = scanner.nextDouble();//get next token (double)
		savingsAccount.deposit(amount1);//deposit into savings account
